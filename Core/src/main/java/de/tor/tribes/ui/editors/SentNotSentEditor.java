 ...
 * @author Torridity
 */
public class SentNotSentEditor extends AbstractCellEditor implements TableCellEditor {

    private JCheckBox editorComponent = null;

    public SentNotSentEditor() {
        editorComponent = new JCheckBox();
        try {
            editorComponent.setIcon(new ImageIcon(this.getClass().getResource("/res/ui/sent_small.gif")));
            editorComponent.setSelectedIcon(new ImageIcon(this.getClass().getResource("/res/ui/unsent_small.gif")));
