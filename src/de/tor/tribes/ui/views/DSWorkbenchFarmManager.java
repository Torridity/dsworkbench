...
/**
 *
 * @author Torridity @TODO upload new parser version if DSWB3.2 is released to
 * enable wall feature
 */
public class DSWorkbenchFarmManager extends AbstractDSWorkbenchFrame implements GenericManagerListener {
    ...
    private void buildMenu() {
        ...
        JXButton markLastFarm = new JXButton(new ImageIcon(DSWorkbenchFarmManager.class.getResource("/res/ui/last_report.png")));
    ...
    public static void main(String args[]) throws Exception {
        /*
         * Image image =
         * Toolkit.getDefaultToolkit().getImage("./graphics/icons/axe.png");
         * final TrayIcon trayIcon = new TrayIcon(image, "Tray Demo"); if
         * (SystemTray.isSupported()) { // get the SystemTray instance
         * SystemTray tray = SystemTray.getSystemTray(); // load an image //
         * create a action listener to listen for default action executed on the
         * tray icon ActionListener listener = new ActionListener() {
         *
         * public void actionPerformed(ActionEvent e) { // execute default
         * action of the application // ... } }; // set the TrayIcon properties
         * trayIcon.addActionListener(listener); // ... // add the tray image
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                /*
                 * for (int i = 0; i < 10; i++) {
                 * trayIcon.displayMessage("Test", "Hello World " +
                 * Math.random(), TrayIcon.MessageType.INFO); try {
