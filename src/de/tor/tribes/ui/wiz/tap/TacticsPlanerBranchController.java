...
public class TacticsPlanerBranchController extends WizardBranchController {
    ...
    private static final Wizard RETIME_PATH = WizardPage.createWizard(new WizardPage[]{RetimerDataPanel.getSingleton(), RetimerSourcePanel.getSingleton(), RetimerSourceFilterPanel.getSingleton(), RetimerCalculationPanel.getSingleton()}, ERGEBNIS);
