...
/**
 * This is the algorithm's central class.
 *
 ...
 * @param <D>
 */
public class AttackOptex<S extends Source,D extends Destination> {
	 ...
	 */
	public AttackOptex(ArrayList<S> sources, ArrayList<D> destinations, Hashtable<Destination,Double> costs[]) {
