...
public class MinimapPanel extends javax.swing.JPanel {
    ...
    public void paint(Graphics g) {
        ...
        double posX = ((double) getWidth() / 1000 * (double) iX) - iWidth / 2;
        double posY = ((double) getHeight() / 1000 * (double) iY) - iHeight / 2;

        g2d.drawRect((int) Math.rint(posX), (int) Math.rint(posY), iWidth, iHeight);
                ...
                if (v != null) {
                    ...
                    if (v.getTribe() == null) {
                        ...
                        if (v.getTribe().getAlly() != null) {
                            if (v.getTribe().getAlly().getName().equals("EL!TE")) {
                                mark = Color.YELLOW;
                            }
                        }
                    }
                    ...
                    /*Color mark = GlobalOptions.getMarkers().get(v.getTribe().getName());
                    if (mark == null) {
                    String name = v.getTribe().getAlly().getName();
                    mark = GlobalOptions.getMarkers().get(name);
