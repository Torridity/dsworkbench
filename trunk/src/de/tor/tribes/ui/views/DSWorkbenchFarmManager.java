...
public class DSWorkbenchFarmManager extends AbstractDSWorkbenchFrame implements GenericManagerListener {
    ...
    private void farm() {
        ...
        int noAdequateSourceByCarryCapacity = 0;
            ...
            if (clickAccount.useClick()) {
                ...
                switch (farm.farmFarm()) {
                    ...
                    case NO_ADEQUATE_SOURCE_BY_CARRY_CAPACITY:
                        noAdequateSourceByCarryCapacity++;
                        break;
        ...
        if (miscMessage == null) {
            showInfo("<html>Ge&ouml;ffnete Tabs: " + opened + "/" + rows.length + "<br/>"
                    + " - " + noAdequateSourceByCarryCapacity + "  Mal kein passendes Herkunftsdorf mit notwendiger Tragekapazit&auml;t<br/>"
