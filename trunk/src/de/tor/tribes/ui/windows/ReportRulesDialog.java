...
public class ReportRulesDialog extends javax.swing.JDialog implements GenericManagerListener {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>Angreifer<br/>(Spieler)</html>");
        ...
        jLabel4.setText("<html>Verteidiger<br/>(Spieler)</html>");
        ...
        jLabel6.setText("<html>Angreifer<br/>(Stamm)</html>");
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jAttackerAllyPanel.add(jLabel6, gridBagConstraints);
        ...
        jLabel9.setText("<html>Verteidiger<br/>(Stamm)</html>");
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.VERTICAL;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        jDefenderAllyPanel.add(jLabel9, gridBagConstraints);
        ...
        jRuleSelection.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Berichtfarbe", "Gesendet von ... bis ...", "Berichtalter", "Angreifer", "Verteidiger", "Angreifer (Stamm)", "Verteidiger (Stamm)", "Offs", "Fakes", "AG-Angriffe", " " }));
    ...
    public ReportFilterInterface createRule(Class pRuleClass) {
        ...
        if (ColorFilter.class.equals(pRuleClass)) {
            ...
            f.setup(new Long[]{jMinDate.getDate().getTime(), jMaxDate.getDate().getTime()});
            result = f;
        } else if (AgeFilter.class.equals(pRuleClass)) {
            AgeFilter f = new AgeFilter();
            long val;
            try {
            ...
            AttackerAllyFilter f = new AttackerAllyFilter();
            f.setup(jAttackerAllyTextArea.getText());
            result = f;
        } else if (DefenderAllyFilter.class.equals(pRuleClass)) {
            DefenderAllyFilter f = new DefenderAllyFilter();
            f.setup(jDefenderAllyTextArea.getText());
            result = f;
        } else if (OffFilter.class.equals(pRuleClass)) {
            OffFilter f = new OffFilter();
            result = f;
        } else if (FakeFilter.class.equals(pRuleClass)) {
            FakeFilter f = new FakeFilter();
            result = f;
        } else if (ConqueredFilter.class.equals(pRuleClass)) {
            ConqueredFilter f = new ConqueredFilter();
            result = f;
        }
