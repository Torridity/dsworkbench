...
import de.tor.tribes.ui.wiz.dep.*;
...
public class AttackCalculationPanel extends javax.swing.JPanel implements WizardPanel {
    ...
    private void initializeCalculation() {
        ...
        for (AttackTargetElement element : AttackTargetPanel.getSingleton().getAllElements()) {
            if (element.isFake()) {
    ...
    public void updateStatus() {
        AttackSourceElement[] elements = AttackSourceFilterPanel.getSingleton().getFilteredElements();
        ...
        offs = 0;
        fakes = 0;
        for (AttackTargetElement element : targetElements) {
            if (element.isFake()) {
