...
public class AttackPlanHTMLExporter {
    ...
    private static Logger logger = Logger.getLogger("HTMLExporter");
    ...
    public static void doExport(File pHtmlFile, String pPlanName, List<Attack> pAttacks) {
        ...
        //set planname
        if (pPlanName != null) {
            h = h.replaceAll(PLANNAME, pPlanName);
        } else {
        ...
        for (Attack a : pAttacks) {
            ...
            if (sourceTribe == null) {
                ...
                b = b.replaceAll(SOURCE_TRIBE, "<a href=\"" + tribeGuest + "\" target=\"_blank\">" + sourceTribe.getName() + "</a>");
                ...
                if (sourceAlly == null) {
                    ...
                    b = b.replaceAll(SOURCE_ALLY, "<a href=\"" + allyGuest + "\" target=\"_blank\">" + sourceAlly.getName() + " (" + sourceAlly.getTag() + ")" + "</a>");
                }
            }
            //replace source village
            String villageGuest = baseURL;
            villageGuest += "guest.php?screen=info_village&id=" + a.getSource().getId();
            b = b.replaceAll(SOURCE_VILLAGE, "<a href=\"" + villageGuest + "\" target=\"_blank\">" + a.getSource().getName() + "</a>");
            //</editor-fold>
            ...
            if (targetTribe == null) {
                ...
                b = b.replaceAll(TARGET_TRIBE, "<a href=\"" + tribeGuest + "\" target=\"_blank\">" + targetTribe.getName() + "</a>");
                //replace source tribe
                ...
                if (targetAlly == null) {
                    ...
                    b = b.replaceAll(TARGET_ALLY, "<a href=\"" + allyGuest + "\" target=\"_blank\">" + targetAlly.getName() + " (" + targetAlly.getTag() + ")" + "</a>");
                }
            }
            //replace target village
            villageGuest = baseURL;
            villageGuest += "guest.php?screen=info_village&id=" + a.getTarget().getId();
            b = b.replaceAll(TARGET_VILLAGE, "<a href=\"" + villageGuest + "\" target=\"_blank\">" + a.getTarget().getName() + "</a>");
            //</editor-fold>
